...
from admin_panel.views import Expansens1,Expansens2,Expansens3,ReccuringExpanses2,ReccuringExpanses3,ReccuringExpanses1,ManagerLogin,AssignedCustomer,LeadsToEstimates
...
urlpatterns = [
    ...
    path('leadstoestimate/<int:id>/',LeadsToEstimates,name="LeadsToEstimates"),
    ...
    path('assignedcustomer/',AssignedCustomer,name="AssignedCustomer"),
